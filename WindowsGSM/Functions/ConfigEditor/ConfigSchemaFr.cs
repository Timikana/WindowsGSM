...
namespace WindowsGSM.Functions.ConfigEditor
{
    ...
    internal static class ConfigSchemaFr
    {
        ...
        private static readonly Dictionary<string, string> Groups = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Population", "Population de zombies" }, { "Zombie behaviour", "Comportement zombies" }, { "Time & weather", "Temps & météo" }, { "Nature & farming", "Nature & agriculture" }, { "Character", "Personnage" }, { "Vehicles", "Véhicules" }, { "Events", "Événements" }, { "Survival", "Survie" }, { "Map", "Carte" }, { "Plumbing", "Plomberie" }
        };
        ...
        private static readonly Dictionary<string, (string label, string desc)> ProjectZomboid = new Dictionary<string, (string, string)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Zombies", ("Population de zombies", "1=Hardcore, 2=Très élevé, 3=Élevé, 4=Normal, 5=Faible, 6=Aucun.") },
            { "Distribution", ("Répartition", "1=Focalisés en ville, 2=Uniforme.") },
            { "DayLength", ("Durée du jour", "Ex. 3 = 1 heure réelle par jour en jeu.") },
            { "StartYear", ("Année de départ", "") },
            { "StartMonth", ("Mois de départ", "") },
            { "StartDay", ("Jour de départ", "") },
            { "StartTime", ("Heure de départ", "") },
            { "WaterShut", ("Coupure d'eau", "Quand l'eau est coupée.") },
            { "ElecShut", ("Coupure d'électricité", "") },
            { "WaterShutModifier", ("Jours avant coupure d'eau", "") },
            { "ElecShutModifier", ("Jours avant coupure d'élec", "") },
            { "FoodLoot", ("Butin : nourriture", "1=Aucun … 4=Normal … 7=Abondant.") },
            { "CannedFoodLoot", ("Butin : conserves", "") },
            { "LiteratureLoot", ("Butin : livres/magazines", "") },
            { "SurvivalGearsLoot", ("Butin : matériel de survie", "") },
            { "MedicalLoot", ("Butin : médical", "") },
            { "WeaponLoot", ("Butin : armes", "") },
            { "RangedWeaponLoot", ("Butin : armes à distance", "") },
            { "AmmoLoot", ("Butin : munitions", "") },
            { "MechanicsLoot", ("Butin : mécanique", "") },
            { "OtherLoot", ("Butin : autres", "") },
            { "Temperature", ("Température", "") },
            { "Rain", ("Pluie", "") },
            { "ErosionSpeed", ("Vitesse d'érosion", "") },
            { "ErosionDays", ("Jours avant érosion", "0 = utilise la vitesse ci-dessus.") },
            { "XpMultiplier", ("Multiplicateur d'XP", "Gain d'XP global (1.0 = normal).") },
            { "XpMultiplierAffectsPassive", ("XP multipl. affecte les passifs", "") },
            { "ZombieAttractionMultiplier", ("Attirance au bruit", "Sensibilité des zombies au bruit (véhicules, armes…).") },
            { "VehicleEasyUse", ("Véhicules faciles à utiliser", "") },
            { "Farming", ("Agriculture", "Vitesse de croissance des cultures.") },
            { "CompostTime", ("Temps de compost", "") },
            { "StatsDecrease", ("Baisse des stats", "Vitesse de baisse faim/soif/fatigue.") },
            { "NatureAbundance", ("Abondance de la nature", "") },
            { "Alarm", ("Alarmes de maison", "Fréquence des alarmes.") },
            { "LockedHouses", ("Maisons verrouillées", "") },
            { "StarterKit", ("Kit de départ", "") },
            { "Nutrition", ("Nutrition détaillée", "") },
            { "FoodRotSpeed", ("Vitesse de pourriture", "") },
            { "FridgeFactor", ("Efficacité du frigo", "") },
            { "LootRespawn", ("Réapparition du butin", "1=Aucune, puis délais croissants.") },
            { "SeenHoursPreventLootRespawn", ("Heures vues bloquant le respawn", "") },
            { "HoursForWorldItemRemoval", ("Heures avant nettoyage des objets au sol", "") },
            { "ItemRemovalListBlacklistToggle", ("Liste noire de nettoyage", "") },
            { "TimeSinceApo", ("Temps depuis l'apocalypse", "Ancienneté du monde au départ (état du loot/nature).") },
            { "PlantResilience", ("Résistance des plantes", "") },
            { "PlantAbundance", ("Abondance des plantes", "") },
            { "EndRegen", ("Repousse de la végétation", "") },
            { "Helicopter", ("Hélicoptère", "Fréquence de l'événement hélicoptère.") },
            { "MetaEvent", ("Méta-événements", "Coups de feu/cris au loin.") },
            { "SleepingEvent", ("Événements de sommeil", "") },
            { "GeneratorSpawning", ("Apparition de générateurs", "") },
            { "GeneratorFuelConsumption", ("Conso carburant générateur", "") },
            { "SurvivorHouseChance", ("Chance maison de survivant", "") },
            { "VehicleStoryChance", ("Chance histoire de véhicule", "") },
            { "ZoneStoryChance", ("Chance histoire de zone", "") },
            { "AnnotatedMapChance", ("Chance de carte annotée", "") },
            { "CharacterFreePoints", ("Points de perso gratuits", "") },
            { "ConstructionBonusPoints", ("Points bonus construction", "") },
            { "NightDarkness", ("Obscurité de la nuit", "") },
            { "NightLength", ("Durée de la nuit", "") },
            { "InjurySeverity", ("Gravité des blessures", "") },
            { "BoneFracture", ("Fractures osseuses", "") },
            { "HoursForCorpseRemoval", ("Heures avant retrait des cadavres", "") },
            { "DecayingCorpseHealthImpact", ("Impact santé des cadavres", "") },
            { "BloodLevel", ("Niveau de sang", "") },
            { "ClothingDegradation", ("Usure des vêtements", "") },
            { "FireSpread", ("Propagation du feu", "") },
            { "DaysForRottenFoodRemoval", ("Jours avant retrait nourriture pourrie", "-1 = jamais.") },
            { "AllowExteriorGenerator", ("Générateur en extérieur", "") },
            { "MaxFogIntensity", ("Intensité max brouillard", "") },
            { "MaxRainFxIntensity", ("Intensité max pluie (FX)", "") },
            { "EnableSnowOnGround", ("Neige au sol", "") },
            { "MultiHitZombies", ("Multi-coups", "Toucher plusieurs zombies d'un seul coup.") },
            { "RearVulnerability", ("Vulnérabilité de dos", "Bonus de dégâts en attaquant de dos.") },
            { "AttackBlockMovements", ("L'attaque bloque le mouvement", "") },
            { "AllClothesUnlocked", ("Tous les vêtements débloqués", "") },
            { "EnableTaintedWaterText", ("Texte eau souillée", "") },
            { "CarSpawnRate", ("Taux d'apparition des voitures", "") },
            { "ChanceHasGas", ("Chance d'avoir de l'essence", "") },
            { "InitialGas", ("Essence initiale", "") },
            { "FuelStationGas", ("Essence des stations-service", "") },
            { "CarGasConsumption", ("Conso essence", "") },
            { "LockedCar", ("Voitures verrouillées", "") },
            { "CarGeneralCondition", ("État général des voitures", "") },
            { "CarDamageOnImpact", ("Dégâts à l'impact", "") },
            { "DamageToPlayerFromHitByACar", ("Dégâts au joueur renversé", "") },
            { "TrafficJam", ("Embouteillages", "") },
            { "CarAlarm", ("Alarmes de voiture", "") },
            { "PlayerDamageFromCrash", ("Dégâts au joueur en accident", "") },
            { "SirenShutoffHours", ("Heures avant arrêt sirène", "") },
            { "RecentlySurvivorVehicles", ("Véhicules de survivants récents", "") },
            { "EnableVehicles", ("Activer les véhicules", "") },
            { "EnablePoisoning", ("Empoisonnement", "") },
            { "MaggotSpawn", ("Apparition d'asticots", "") },
            { "LightBulbLifespan", ("Durée de vie des ampoules", "") },
            { "Map.AllowMiniMap", ("Mini-carte autorisée", "") },
            { "Map.AllowWorldMap", ("Carte du monde autorisée", "") },
            { "Map.MapAllKnown", ("Carte entièrement révélée", "") },
            { "ZombieLore.Speed", ("Vitesse", "1=Sprinters, 2=Marcheurs rapides, 3=Marcheurs, 4=Aléatoire.") },
            { "ZombieLore.Strength", ("Force", "1=Surhumaine, 2=Normale, 3=Faible.") },
            { "ZombieLore.Toughness", ("Résistance", "1=Coriace, 2=Normale, 3=Fragile.") },
            { "ZombieLore.Transmission", ("Transmission", "1=Sang+salive, 2=Salive seule, 3=Aucune.") },
            { "ZombieLore.Mortality", ("Mortalité (délai d'infection)", "Rapidité à laquelle une morsure tue.") },
            { "ZombieLore.Reanimate", ("Délai de réanimation", "") },
            { "ZombieLore.Cognition", ("Cognition", "1=Peuvent ouvrir portes, 2=Basique, 3=Aucune.") },
            { "ZombieLore.CrawlUnderVehicle", ("Rampent sous les véhicules", "") },
            { "ZombieLore.Memory", ("Mémoire", "Durée pendant laquelle ils vous traquent.") },
            { "ZombieLore.Sight", ("Vue", "") },
            { "ZombieLore.Hearing", ("Ouïe", "") },
            { "ZombieLore.ThumpNoChasing", ("Tapent sans poursuivre", "") },
            { "ZombieLore.ThumpOnConstruction", ("Tapent sur les constructions", "") },
            { "ZombieLore.ActiveOnly", ("Actifs", "1=Les deux, 2=Le jour, 3=La nuit.") },
            { "ZombieLore.TriggerHouseAlarm", ("Déclenchent les alarmes", "") },
            { "ZombieLore.ZombiesDragDown", ("Peuvent vous traîner au sol", "") },
            { "ZombieLore.ZombiesFenceLunge", ("Attaquent par-dessus les clôtures", "") },
            { "ZombieLore.DisableFakeDead", ("Désactiver les faux morts", "") },
            { "ZombieConfig.PopulationMultiplier", ("Multiplicateur de population", "Densité globale de zombies (1.0 = normal).") },
            { "ZombieConfig.PopulationStartMultiplier", ("Population au départ", "") },
            { "ZombieConfig.PopulationPeakMultiplier", ("Population au pic", "") },
            { "ZombieConfig.PopulationPeakDay", ("Jour du pic de population", "") },
            { "ZombieConfig.RespawnHours", ("Heures avant réapparition", "0 = pas de réapparition de zombies.") },
            { "ZombieConfig.RespawnUnseenHours", ("Heures zone non vue", "") },
            { "ZombieConfig.RespawnMultiplier", ("Multiplicateur de réapparition", "") },
            { "ZombieConfig.RedistributeHours", ("Heures de redistribution", "") },
            { "ZombieConfig.FollowSoundDistance", ("Distance de suivi du son", "") },
            { "ZombieConfig.RallyGroupSize", ("Taille des hordes", "") },
            { "ZombieConfig.RallyTravelDistance", ("Distance de déplacement des hordes", "") },
            { "ZombieConfig.RallyGroupSeparation", ("Séparation des hordes", "") },
            { "ZombieConfig.RallyGroupRadius", ("Rayon des hordes", "") },
            { "Plumbing.PumpFilterUsage", ("Usure du filtre de pompe", "") },
            { "Plumbing.PumpEfficiencyLoss", ("Perte d'efficacité de la pompe", "") },

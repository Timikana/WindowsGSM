...
namespace WindowsGSM.Functions.Notifications
{
    ...
    public class NotificationsDialog : Window
    {
        ...
        private Border BuildNtfyCard()
        {
            ...
            sp.Children.Insert(3, TextRow(Loc.T("Notif.NtfyToken"), c.AuthToken, v => c.AuthToken = v));
        ...
        private Border BuildTelegramCard()
        {
            ...
            sp.Children.Insert(1, TextRow(Loc.T("Notif.TelegramBotToken"), c.BotToken, v => c.BotToken = v));
        ...
        private Border BuildEmailCard()
        {
            ...
            sp.Children.Insert(5, TextRow(Loc.T("Notif.EmailPassword"), c.Password, v => c.Password = v));

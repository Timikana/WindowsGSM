...
namespace WindowsGSM.Functions
{
    ...
    public class ApiTokenDialog : Window
    {
        ...
        private readonly WindowsGSM.Functions.Controls.RevealPasswordBox _box;
        ...
        public ApiTokenDialog(string serverId, string serverName, bool isSatisfactory)
        {
            ...
            var label = new TextBlock { Text = Loc.T("ApiToken.FieldLabel"), Foreground = WindowsGSM.Functions.Controls.DialogTheme.Fg, TextWrapping = TextWrapping.Wrap, Margin = new Thickness(0, 0, 0, 4) };
            DockPanel.SetDock(label, Dock.Top);
            outer.Children.Add(label);

            _box = new WindowsGSM.Functions.Controls.RevealPasswordBox();
            _box.UseMonospace();

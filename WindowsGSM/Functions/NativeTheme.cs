        ...
        public static void EnableDarkTitleBar(Window window)
        {
            ...
            void Apply()
            {
                try
                {
                    ...
                    // Match the title bar to the active theme (was always dark -> white-on-white close
                    // buttons issues aside, a dark title bar over a light dialog looks wrong).
                    int on = Controls.DialogTheme.IsLightTheme ? 0 : 1;
